...
export const DailySummary = ({ dailyTransactions, columns }: DailySummaryProps) => {
    const { income, expense, balance } = useMemo(() => financeCalclations(dailyTransactions), [dailyTransactions]);
